...
public final class GqlCastMemberPresenter {
    ...
    public static GqlCastMember present(final ListCastMemberOutput out) {
        return new GqlCastMember(out.id(), out.name(), out.type().name(), out.createdAt(), out.updatedAt());
    }
    ...
    public static GqlCastMember present(final CastMember aMember) {
        return new GqlCastMember(aMember.id(), aMember.name(), aMember.type().name(), aMember.createdAt(), aMember.updatedAt());
    }
